    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.Div([
                ...
                create_download_component("urbanization-bubble-download"),
            ...
            html.Div([
                dbc.Tabs(
                    [
                        ...
                        dbc.Tab(label="Urbanization Dynamics", tab_id="urbanization-bubble", label_class_name="tab-blue"),
            ...
            html.Div([
                dbc.Tabs(
                    [
                        ...
                        dbc.Tab(label="Probable Maximum Loss Benchmark", tab_id="probable-maximum-loss-benchmark", label_class_name="tab-blue"),
                    ],
