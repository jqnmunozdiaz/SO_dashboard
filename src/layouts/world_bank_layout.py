            ...
            html.Div([
                dbc.Tabs(
                    [
                        ...
                        dbc.Tab(label="Built-up and Population Growth Rate in Cities", tab_id="cities-growth-rate"),
                        dbc.Tab(label="Cities Growth", tab_id="cities-growth", label_style={"color": "#e67e22"}),
                        dbc.Tab(label="Built-up per capita in Cities", tab_id="urban-density", label_style={"color": "#e67e22"}),
                    ],
