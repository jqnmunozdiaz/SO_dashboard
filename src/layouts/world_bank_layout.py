...
def create_world_bank_urbanization_tab_content():
    """Create World Bank-styled content for the Urbanization Trends tab matching Review_CatDDOs"""
    return html.Div([
        html.Div([
            # Filter controls section
            html.Div([
...
def create_world_bank_flood_risk_tab_content():
    """Create World Bank-styled content for the Flood Risk Assessment tab matching Review_CatDDOs"""
    return html.Div([
        html.Div([
            # Filter controls section
            html.Div([
            ...
            html.Div([
                ...
                ], style={'display': 'flex', 'gap': '0', 'margin-bottom': '1.5rem'}),
